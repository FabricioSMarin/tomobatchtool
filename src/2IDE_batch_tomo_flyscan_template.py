...
scans [x-center(um), y-center.(um), theta (deg), x-width.(um), y-width.(um), x-stepsize.(um), Y-stepsize.(um), dwell.(ms)]
scans [x-center(um), y-center.(um), theta (deg), npts-x, npts-y, x-stepsize.(um), Y-stepsize.(um), dwell.(ms)]
scans [x_width, x_step, x_center, y_width, y_step, y_center, theta, dwell]
scans [x_width, x_npts, x_center, y_width, y_npts, y_center, theta, dwell]
...
old =['2xfm:m200.VAL', '2xfm:m13.VAL', '2xfm:m58.VAL', '2xfm:FscanH.NPTS',
       '2xfm:Fscan1.NPTS', '2xfm:FscanH.P1SI', '2xfm:Fscan1.P1SI', '2xfm:Flyscans:Setup:DwellTime.VAL']

pvs = ['2xfm:FscanH.P1WD', '2xfm:FscanH.NPTS', '2xfm:m200.VAL', '2xfm:Fscan1.P1WD', '2xfm:Fscan1.NPTS',
        '2xfm:m13.VAL', '2xfm:m58.VAL', '2xfm:Flyscans:Setup:DwellTime.VAL']
